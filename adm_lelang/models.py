...
class pengumuman(models.Model):
    ...
    dokumen = models.FileField(upload_to="upload/adm_lelang/", null=True, verbose_name="File Pengumuman")
...
class undangan(models.Model):
    ...
    file = models.FileField(verbose_name="Berkas", upload_to="upload/files/")
    last_updated = models.DateTimeField(auto_now=True, editable=False)
    created = models.DateTimeField(auto_now_add=True, editable=False)
...
class berita_acara(models.Model):
    ...
    file = models.FileField(upload_to="upload/files/", blank=True, default="upload/files/kosong.pdf")
